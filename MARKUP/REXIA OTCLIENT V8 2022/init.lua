-- CONFIG
APP_NAME = "Rexia20"  -- important, change it, it's name for config dir and files in appdata
APP_VERSION = 1341       -- client version for updater and login to identify outdated client
DEFAULT_LAYOUT = "Mishak47" -- on android it's forced to "mobile", check code bellow
