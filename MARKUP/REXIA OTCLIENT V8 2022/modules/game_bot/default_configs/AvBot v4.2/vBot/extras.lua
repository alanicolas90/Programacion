...
addCheckBox("checkPlayer", "Check Players", false, rightPanel)
if true then
  local found
  ...
  onTextMessage(function(mode, text)
    ...
    if #re ~= 0 then
        ...
        elseif text:lower():find("knight") then
            voc = "EK"
		elseif text:lower():find("maker") then
            voc = "ED"
		elseif text:lower():find("mage") then
            voc = "MS"
		elseif text:lower():find("slayer") then
            voc = "EK"
		elseif text:lower():find("shinobi") then
            voc = "RP"
