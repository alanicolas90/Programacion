Feature: Cambiar el apellido de un miembro familiar

  Scenario: cambia el apellido del miembro
    Given usuario{nombre: "Juan", apellido: "Perez", email: "xxx@gmail.com",usuario:"juanpe123", password: "123456"}
    And nuevo apellido:"Jose" and contraseña:"123456"
    When cambiar apellido
    Then usuario{nombre: "Jose", apellido: "Perez", email: "xxx@gmail.com",usuario:"juanpe123", password: "123456"}

  Scenario: no se cambia el apellido del miembro porque la contraseña es incorrecta
    Given usuario{nombre: "Juan", apellido: "Perez", email: "xxx@gmail.com",usuario:"juanpe123", password: "123456"}
    And nuevo apellido:"Jose" and contraseña:"1234567"
    When cambiar apellido
