Feature: como cliente quiero pagar el carrito de compra
  ...
  Scenario: pago con éxito
    ...
    When pago 128$ con la tarjeta 0550 0621  bajo el nombre de 27/04/2022
  ...
  Scenario: poco dinero para pagar
    ...
    When pago 128$ con la tarjeta 9876 1234  bajo el nombre de 27/04/2022
  ...
  Scenario: tarjeta no existe
    ...
    When pago 128$ con la tarjeta 0000 1111 bajo el nombre de 27/04/2022
