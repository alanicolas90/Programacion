...
public class PrincipalController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        productos.add(new Producto("Pizza", 10.0, 10));
        productos.add(new Producto("Hamburguesa", 10.0, 10));
        productos.add(new Producto("Pollo", 10.0, 10));
    ...
    private void add() {
        ...
        Producto nuevoProduct = new Producto(txtNombre.getText(), Double.parseDouble(txtPrice.getText()), Integer.parseInt(txtStock.getText()));
    ...
    public void updateData() {
        ...
        if (productTabla != null) {
            table.getItems().remove(productTabla);
            table.getItems().add(new Producto(nombre.getText(), Double.parseDouble(precio.getText()), Integer.parseInt(stock.getText())));
        }
