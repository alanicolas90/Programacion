...
public class BBDD {
    ...
    static {
        ...
        clientes.put("111", new Cliente("111", "alain", "mikolajczyk"));
        clientes.put("233", new Cliente("233", "alean", "mikolajczyk"));
        clientes.put("333", new Cliente("333", "alaan", "mikolajczyk"));
        clientes.put("223", new Cliente("223", "allan", "mikolajczyk"));
        ...
        clientes.get("000").setDineroTotalGastado(100);
        clientes.get("111").setDineroTotalGastado(50);
        clientes.get("233").setDineroTotalGastado(20000);
